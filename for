  ...
  <body>
    ...
    <div class="example" id="for">
      ...
      <table>
        ...
        <tr>
          <td class="docs">
            <p><code>for</code> 是 Go 中唯一的循环结构。这里会展示 <code>for</code> 循环的三种基本使用方式。</p>
        ...
        <tr>
          ...
          <td class="code leading">
            <a href="https://play.studygolang.com/p/CO63wfs0BpO"><img title="Run code" src="play.png" class="run" /></a><img title="Copy code" src="clipboard.png" class="copy" />
        ...
        <tr>
          ...
          <pre tabindex="0" class="chroma"><span class="kn">import</span> <span class="s">&#34;fmt&#34;</span></pre>
          </td>
        </tr>
...
<span class="p">}</span></pre>
      ...
      <table>
        ...
        <tr>
          ...
          <pre tabindex="0" class="chroma"><span class="gp">$</span> go run for.go
<span class="go">1
